...
class RegistrationViewTest(TestCase, MoloTestCaseMixin):
    ...
    def test_first_page_pagination(self):
        ...
        self.assertContains(response, '<a href="?p=2"
            class="pagination__page">2</a>')
        self.assertContains(response, '<a href="?p=3"
            class="pagination__page">3</a>')
        self.assertContains(response, '...')
        self.assertContains(response, '<a href="?p=15"
            class="pagination__page">15</a>')
        self.assertContains(response, '<a href="?p=16"
            class="pagination__page">16</a>')
    ...
    def test_second_page_pagination(self):
        ...
        self.assertContains(response, '<a href="?p=1"
            class="pagination__page">1</a>')
        self.assertContains(response, '<a href="?p=3"
            class="pagination__page">3</a>')
        self.assertContains(response, '<a href="?p=4"
    ...
    def test_third_page_pagination(self):
        ...
        self.assertContains(response, '<a href="?p=4"
            class="pagination__page">4</a>')
        self.assertContains(response, '<a href="?p=5"
    ...
    def test_fifth_page_pagination(self):
        ...
        self.assertContains(response, '<a href="?p=4"
            class="pagination__page">4</a>')
        self.assertContains(response, '<a href="?p=6"
            class="pagination__page">6</a>')
        self.assertContains(response, '<a href="?p=7"
            class="pagination__page">7</a>')
        self.assertContains(response, '...')
        self.assertContains(response, '<a href="?p=15"
            class="pagination__page">15</a>')
        self.assertContains(response, '<a href="?p=16"
    ...
    def test_fourteenth_page_pagination(self):
        ...
        self.assertContains(response, '<a href="?p=2"
            class="pagination__page">2</a>')
        self.assertContains(response, '...')
        self.assertContains(response, '<a href="?p=12"
            class="pagination__page">12</a>')
        self.assertContains(response, '<a href="?p=13"
            class="pagination__page">13</a>')
        self.assertContains(response, '<a href="?p=15"
            class="pagination__page">15</a>')
        self.assertContains(response, '<a href="?p=16"
            class="pagination__page">16</a>')
    ...
    def test_fifteenth_page_pagination(self):
        ...
        self.assertContains(response, '<a href="?p=13"
            class="pagination__page">13</a>')
        self.assertContains(response, '<a href="?p=14"
            class="pagination__page">14</a>')
        self.assertContains(response, '<a href="?p=16"
            class="pagination__page">16</a>')
        self.assertContains(response, 'Next')
